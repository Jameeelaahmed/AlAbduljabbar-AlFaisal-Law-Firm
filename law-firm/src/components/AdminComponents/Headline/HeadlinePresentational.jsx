function HeadlinePresentational({ headlineLabel, buttonLabel, buttonIcon }) {
    return (
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
            ...
            {buttonLabel &&
                <button className="bg-primary text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-primary/80 cursor-pointer transition-colors text-sm sm:text-base w-full sm:w-auto">
