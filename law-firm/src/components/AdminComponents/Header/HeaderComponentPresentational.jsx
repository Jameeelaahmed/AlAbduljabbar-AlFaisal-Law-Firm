...
export default function HeaderComponentPresentational({ currentLang, handleLanguageChange }) {
                            ...
                            <div className="flex space-x-4">
                                {["Dashboard", "Team", "Projects", "Calendar"].map((item) => (
                                    <a
                                        key={item}
                                        href="#"
                                        className={`rounded-md px-3 py-2 text-sm font-medium ${item === "Dashboard"
